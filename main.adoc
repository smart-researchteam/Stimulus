...
- des explications sur les éléments de base de {stimulus} en <<basics>> (uniquement en anglais pour l'instant), et
- des explications sur les éléments avancés de {stimulus} en <<advanced>> (uniquement en anglais pour l'instant).

TIP: Une **F**oire **A**ux **Q**uestions (FAQ) est disponible en <<faq>> (uniquement en anglais pour l'instant).
endif::[]
